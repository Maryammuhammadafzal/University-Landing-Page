...
const HeroPage = () => {
  return (
    <div className='w-full lg:h-screen h-[60vh] flex flex-col relative bg-secondary bg-blend-multiply items-center bg-cover bg-center' style={{ backgroundImage: `url('/images/hero-bg.png')`}}>
