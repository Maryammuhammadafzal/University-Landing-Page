...
const BannerPage = () => {
    return (
        <div className='w-full h-auto  lg:my-20 lg:gap-0 md:my-14 gap-4 sm:my-8 my-4 flex justify-center items-center'>
            <div className='w-full h-full min-h-[400px] flex md:flex-row relative flex-col bg-[#C5A100] justify-center md:items-center bg-center bg-cover bg-blend-multiply' style={{ backgroundImage : `url('/images/hero-bg.png')`}} >
            ...
            <div className='w-[365px] bg-secondary absolute right-0 z-20 h-[365px]'>
            </div>
